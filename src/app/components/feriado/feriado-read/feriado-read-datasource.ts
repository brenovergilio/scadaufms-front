 ...
 */
export class FeriadoReadDataSource extends DataSource<Feriado> {
  data: Feriado[] = [];
   ...
   */
  private getPagedData(data: Feriado[]): Feriado[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Feriado[]): Feriado[] {
